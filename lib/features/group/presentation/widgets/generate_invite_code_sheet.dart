    ...
    return SafeArea(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Genera codice', style: typography.titleMedium.copyWith(color: colors.textPrimary)),
            ...
            SwitchListTile.adaptive(
              ...
              subtitle: Text(
                _hasExpiry ? 'Tra $_defaultExpiryDays giorni' : 'Nessuna scadenza',
            ...
            AppTextField(
              label: 'Numero massimo di utilizzi (facoltativo)',
